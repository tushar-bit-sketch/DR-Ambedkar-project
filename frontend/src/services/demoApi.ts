...
export const FALLBACK_SYSTEM_STATUS: SystemStatusResponse = {
  ...
  subsystems: {
    database: { name: "Database Engine", status: "OPERATIONAL", provider: "SQLite 3 / PostgreSQL Ready", version: "SQLAlchemy 2.0.28", details: "33 verified records, 8 collections with SHA-256 immutability." },
    ...
    knowledge_graph: { name: "Knowledge Graph Engine", status: "OPERATIONAL", provider: "NetworkX Topology", version: "BFS Depth-3", details: "35 canonical entities, 25 verified relationships with 6-step provenance." },
